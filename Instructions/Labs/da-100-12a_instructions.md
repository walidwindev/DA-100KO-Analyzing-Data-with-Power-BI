...
7. 메뉴 모음에서 **공유**를 클릭합니다.

	![그림 82](Linked_image_Files/PowerBI_Lab12A_image4.png)

8. **공유 대시보드** 창(오른쪽에 위치)의 **액세스 권한 부여 대상** 상자에서 교실 파트너의 계정 이름 입력을 시작합니다. 계정 이름이 목록에 나열되면 선택합니다.

9. 사용 가능한 옵션을 검토하지만 변경하지는 않습니다.

10. 창의 하단에서 **공유**를 클릭합니다.
...
12. **영업 모니터링** 대시보드가 나열되어 있습니다.

	![그림 85](Linked_image_Files/PowerBI_Lab12A_image7.png)

13. 대시보드를 열려면 **영업 모니터링** 대시보드를 클릭합니다.

14. 대시보드 **판매 YTD** 타일 값은 **1300만 달러**입니다.
...
27. **특정 개인 또는 그룹** 상자에서 클래스룸 파트너의 계정 이름 입력을 시작하고 계정 이름이 목록에 나타나면 선택합니다.
...
32. 페이지 중간에서 **앱 가져오기**를 클릭합니다.

	![그림 139](Linked_image_Files/PowerBI_Lab12A_image20.png)

33. 교실 파트너가 게시한 **영업 분석** 앱의 경우 AppSource 창에서 **지금 가져오기** 링크를 클릭합니다.

	![그림 140](Linked_image_Files/PowerBI_Lab12A_image21.png)

34. 앱이 추가된 후 앱을 열려면, 앱 타일을 클릭합니다.

	![그림 141](Linked_image_Files/PowerBI_Lab12A_image22.png)

35. 앱이 열리면, (왼쪽의) 탐색 창을 검토합니다.

36. 탐색 창의 첫 번째 항목은 열려 있습니다.

37. 탐색 창에서 **영업 보고서**를 확장한 다음 **개요** 페이지를 선택합니다.

 	![그림 143](Linked_image_Files/PowerBI_Lab12A_image23.png)

38. **지역** 슬라이서는 Pamela Ansam-Wolfe에 할당된 두 지역만 표시합니다.

	![그림 145](Linked_image_Files/PowerBI_Lab12A_image24.png)

39. **내 실적** 페이지를 선택합니다.

40. 페이지에 Pamela Ansam-Wolfe의 판매 실적과 목표가 표시됩니다.

41. **영업 탐색** 보고서를 열고 각 페이지의 시각적 개체와 상호 작용합니다.

...
3. **영업 분석** 데이터 집합에 대한 라이브 연결을 만듭니다.
...
6. 시각적 개체 저장소에 다음 필드를 추가합니다.
	...
	* Play Axis: **날짜 | Quarter**

	![그림 39](Linked_image_Files/PowerBI_Lab11A_image7.png)

	*필드가 **Play Axis** 웰에 추가되면 차트를 애니메이션화할 수 있습니다*.

7. **필터** 창에서 **제품 | 범주** 필드를 **이 페이지의 필터**에 잘 추가합니다.

8. 필터 카드에서 **자전거**로 필터링합니다.

	![그림 40](Linked_image_Files/PowerBI_Lab11A_image8.png)

9. 차트를 애니메이션화하려면 왼쪽 하단 모서리에서 **재생**을 클릭합니다.

	![그림 41](Linked_image_Files/PowerBI_Lab11A_image9.png)

10. **FY2018 Q1**부터 **FY2020 Q4**까지의 전체 애니메이션 주기를 시청합니다.

	*분산 차트를 사용하면 측정값을 동시에 이해할 수 있습니다(이 경우 주문 수량, 판매 수익 및 이익률)*.

	*각 거품형은 재판매인 비즈니스 유형을 나타냅니다. 거품 크기의 변화는 주문 수량이 증가하거나 감소하는 것을 반영합니다. 수평 이동은 매출의 증가/감소를 나타내며 수직 이동은 수익성 증가/감소를 나타냅니다*.

11. 애니메이션이 중지되면 거품 중 하나를 클릭하여 시간 경과에 따른 추적을 표시합니다.

12. 거품 위를 마우스로 가리켜서 해당 시점에 재판매인 유형에 대한 측정값을 설명하는 도구 설명을 표시합니다.

13. **필터** 창에서 **의류**로만 필터링하면 매우 다른 결과가 생성됩니다.
...
26. 선 시각적 개체에서 예측이 기록 데이터를 한 달 이상 연장한 것을 알 수 있습니다.
...
27. **필터** 창에서 **의류**로만 필터링하면 다른 결과가 생성됩니다.

28. Power BI Desktop 파일을 저장합니다.
...
33. **필터** 창에서 **날짜** 추가** | 연도** 필드를 **이 페이지의 필터**에 잘 추가하고 필터를 **FY2020**으로 설정합니다.

	![그림 59](Linked_image_Files/PowerBI_Lab11A_image24.png)

34. 분해 트리 시각적 개체에서 트리의 루트를 확인합니다. **이익률** -0.94%

	![그림 60](Linked_image_Files/PowerBI_Lab11A_image25.png)

35. 플러스 아이콘을 클릭하고 컨텍스트 메뉴에서 **높은 값**을 선택합니다.

	![그림 61](Linked_image_Files/PowerBI_Lab11A_image26.png)

36. 의사 결정 트리는 가장 높은 이윤으로 주문한 재판매인을 제시합니다.

37. 해당 수준을 제거하려면 시각적 개체 상단에서 **재판매인** 레이블 옆에 있는 **X**를 클릭합니다.

	![그림 62](Linked_image_Files/PowerBI_Lab11A_image27.png)

38. 플러스 아이콘을 다시 클릭한 다음 **국가-지역** 수준으로 확장합니다.

39. **미국**에서 **시-도** 수준으로 확장합니다.

40. **주-도**의 시각적 개체 하단에 있는 아래쪽 화살표를 사용한 다음 수익성이 낮은 상태로 스크롤합니다.

41. **뉴욕** 주는 수익성이 부정적임을 알 수 있습니다.

42. **뉴욕**에서 **재판매인** 수준으로 확장합니다.

43. 근본 원인을 쉽게 분리할 수 있습니다.
...
46. **삽입** 리본의 **AI 시각적 개체** 그룹 내부에서 **주요 영향 요인**을 클릭합니다.

	*팁: AI 시각적 개체는 **시각화** 창에서도 사용할 수 있습니다*.

	![그림 71](Linked_image_Files/PowerBI_Lab11A_image30.png)

47. 전체 페이지를 채울 수 있도록 시각적 개체의 위치를 재배치하고 크기를 조정합니다.

	![그림 72](Linked_image_Files/PowerBI_Lab11A_image31.png)

48. 시각적 개체 저장소에 다음 필드를 추가합니다.

	* 분석: **영업 | 이익률**

	* 설명: **Reseller | 비즈니스 유형** 및 **재판매인 | 지리** (전체 계층 구조)

	* 확장 기준: **영업 | 수량**

	![그림 3](Linked_image_Files/PowerBI_Lab11A_image32.png)

49. 시각적 개체의 왼쪽 상단에는 **키 영향 요소**에 초점을 맞추고 있으며 특정 영향 요소는 증가할 이익의 마진을 포함하는 것을 이해하도록 설정되어 있습니다.

	![그림 76](Linked_image_Files/PowerBI_Lab11A_image33.png)

50. 결과를 검토하면 **Bothel** 도시가 증가할 가능성이 더 높습니다.

51. 대상을 수정하여 이윤이 감소하는 데 영향을 미치는 것이 무잇인지 확인합니다.

	![그림 77](Linked_image_Files/PowerBI_Lab11A_image34.png)

52. 결과 검토.

53. 세그먼트를 감지하려면 왼쪽 상단에서 **상위 세그먼트**를 선택합니다.

	![그림 78](Linked_image_Files/PowerBI_Lab11A_image35.png)

54. 이제 이윤이 높을 가능성이 있는 세그먼트를 결정하는 것이 목표입니다.

55. 시각적 개체가 세그먼트(원)를 표시하면 세그먼트 중 하나를 클릭하여 세그먼트에 대한 정보를 표시합니다.
...
59. 파일을 **판매 분석** 작업 영역에 게시합니다.

60. Power BI Desktop을 닫습니다.

...
이 랩에서는 고급 디자인 기능을 통해 **영업 보고서**를 개선합니다.
...
11. **제품 세부 정보** 페이지 탭을 마우스 오른쪽 단추로 클릭한 다음 **페이지 숨기기**를 선택합니다.
...
21. 시각적 개체에 대한 형식 옵션을 구성하고 **그리드** 섹션에서 **텍스트 크기** 속성을  **20pt**로 설정합니다.
...
23. 시각적 개체 필드 창에서 **이익률** 필드의 경우 아래쪽 화살표를 클릭한 다음 **조건부 서식**을 선택합니다.** | 아이콘**.

	![그림 107](Linked_image_Files/PowerBI_Lab09A_image17.png)

24. **아이콘 – 이익률** 창의 **아이콘 레이아웃** 드롭다운 목록에서 **데이터의 오른쪽**을 선택합니다.

	![그림 108](Linked_image_Files/PowerBI_Lab09A_image18.png)

25. 중간 규칙을 삭제하려면 노란색 삼각형 왼쪽에 있는 **X**를 클릭합니다.

	![그림 109](Linked_image_Files/PowerBI_Lab09A_image19.png)

26. 첫 번째 규칙(빨간색 다이아몬드)을 다음과 같이 구성합니다.
...
27. 두 번째 규칙(녹색 원)을 다음과 같이 구성합니다.
...
29. 테이블 시각적 개체에서 아이콘이 올바르게 표시되는지 확인합니다.

	![그림 112](Linked_image_Files/PowerBI_Lab09A_image22.png)

30. **색상** 필드에 대한 배경 색상 조건부 서식을 구성합니다.

31. **배경색 – 색상** 창의 **다음 형식 사용** 드롭다운 목록에서 **필드 값**을 선택합니다.

	![그림 113](Linked_image_Files/PowerBI_Lab09A_image23.png)

32. **필드 기반** 드롭다운 목록에서 **제품 | 형식 지정 | 배경 색 형식**을 선택합니다.
...
34. 이전 단계를 반복하여 **제품**을 사용하여 **색상** 필드에 대한 글꼴 색상 조건부 서식을 구성합니다.** | 형식 지정 | 글꼴 색상 형식** 필드

	*배경 및 글꼴 색상은 **랩 02A**의 **ColorFormats.csv** 파일을 원본으로 사용했고 **Lab 03A의 **제품** 쿼리와 통합된 것을 기억하십시오.
...
36. **창 표시** 그룹 내의 **보기** 리본 탭에서 **책갈피**를 클릭합니다.

	![그림 118](Linked_image_Files/PowerBI_Lab09A_image27.png)

37. **창 표시** 그룹 내의 **보기** 리본 탭에서 **선택**을 클릭합니다.

	![그림 119](Linked_image_Files/PowerBI_Lab09A_image28.png)

38. **선택** 창에서 **월별 판매 및 목표** 항목 중 하나 옆에 시각적 개체를 숨기려면 눈 아이콘을 클릭합니다.

	![그림 120](Linked_image_Files/PowerBI_Lab09A_image29.png)

39. **책갈피** 창에서 **추가**를 클릭합니다.

	![그림 121](Linked_image_Files/PowerBI_Lab09A_image30.png)

40. 책갈피의 이름을 바꾸려면 책갈피를 두 번 클릭합니다.

41. 표시된 차트가 가로 막대형 차트인 경우 책갈피 이름을 **가로 막대형 차트 켜기**로 바꾸고 그렇지 않은 경우 책갈피 이름을 **세로 막대형 차트 켜기**로 바꿉니다.

42. **선택** 창에서 두 **월별 판매 및 목표** 항목의 가시성을 전환합니다.

	*즉, 보이는 시각적 개체는 숨기고 숨겨진 시각적 개체는 보이도록 합니다*.

	![그림 122](Linked_image_Files/PowerBI_Lab09A_image31.png)

43. 두 번째 책갈피를 만들고 적절하게 이름을 지정합니다. (**열 차트 켜기** 또는 **막대형 차트 켜기)**

	![그림 123](Linked_image_Files/PowerBI_Lab09A_image32.png)

44. **선택** 창에서 두 시각적 개체를 모두 표시하려면 숨겨진 시각적 개체를 간단하게 표시합니다.

45. 두 시각적 개체의 크기를 조정하고 위치를 변경하여 다중 카드 시각적 개체 아래에 있는 페이지를 채우고 서로 완전히 겹치게 합니다.

	*팁: 가려진 시각적 개체를 선택하려면 **선택** 창에서 선택합니다*.

	![그림 124](Linked_image_Files/PowerBI_Lab09A_image33.png)

46. **책갈피** 창에서 각 책갈피를 선택하면 하나의 시각적 개체만 볼 수 있습니다.
...
48. **연도** 슬라이서 바로 아래에 단추를 재배치합니다.

49. 단추를 선택하고 **시각화** 창에서 **단추 텍스트** 속성을 **켜기**로 설정합니다.

	![그림 126](Linked_image_Files/PowerBI_Lab09A_image35.png)

50. **단추 텍스트** 섹션을 확장한 다음 **단추 텍스트** 상자에 **막대형 차트**를 입력합니다.

51. 적절한 색상을 사용하여 배경 색상을 형식 지정합니다.

52. **작업** 속성을 **켜기**로 전환합니다(목록의 맨 아래에 있음).

	![그림 127](Linked_image_Files/PowerBI_Lab09A_image36.png)

53. **작업** 섹션을 펼친 다음 **형식** 드롭다운 목록을 **책갈피**로 설정합니다.

54. **책갈피** 드롭다운 목록에서 **막대형 차트 켜기**를 선택합니다.

	![그림 128](Linked_image_Files/PowerBI_Lab09A_image37.png)

55. 복사 및 붙여넣기를 사용하여 단추의 복사본을 만든 후 다음과 같이 새 단추를 구성합니다.
...
57. **연도** 슬라이서에서 **FY2020**을 선택합니다.

58. **지역** 슬라이서에서 **모두 선택**을 선택합니다.

59. Power BI Desktop 파일을 저장합니다.

60. 보고서를 **판매 분석** 작업 영역에 게시합니다.

61. 보고서를 바꾸라는 메시지가 표시되면 **바꾸기**를 클릭합니다.

	![그림 129](Linked_image_Files/PowerBI_Lab09A_image38.png)

62. Power BI Desktop을 열어 둡니다.
...
64. 드릴스루 보고서를 테스트하려면 **범주별 수량** 시각적 개체에서 **의류** 막대를 마우스 오른쪽 단추로 클릭한 다음 **드릴 스루**를 선택합니다.** | 제품 세부 정보**.

	![그림 130](Linked_image_Files/PowerBI_Lab09A_image39.png)

65. **제품 세부 정보** 페이지는 **의류**용입니다.

66. 원본 페이지로 돌아가려면 왼쪽 위 모서리에서 화살표 단추를 클릭합니다.

67. **내 실적** 페이지를 선택합니다.

68. 각 단추를 클릭한 다음 표시되는 다른 시각적 개체를 확인합니다.
...
70. Microsoft Edge 브라우저 창을 열어 둡니다.

71. Power BI Desktop에서 **실적** 페이지로 이동하고 **필드** 창에서 **영업 사원** 필터 카드를 제거합니다.

	![그림 132](Linked_image_Files/PowerBI_Lab09A_image41.png)

72. **개요** 페이지를 선택합니다.

73. Power BI Desktop 파일을 저장한 다음 **판매 분석** 작업 영역에 다시 게시합니다.

74. Power BI Desktop을 닫습니다.

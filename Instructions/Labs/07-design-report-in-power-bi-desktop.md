...
19. Microsoft Edge 브라우저 창을 열어 둡니다.
...
8. **열기** 창에서 **D:\DA100\Labs\design-report-in-power-bi-desktop\Starter** 폴더로 이동합니다.
...
25. 시각적 개체 필드 창(**필드** 창이 아니며 **시각화** 창 아래에 시각적 필드 창 위치)에서 필드가 **공유 축** 및 **열 값**에 할당되었는지 확인합니다.
	...
	*여러 시각적 개체를 한 시각적 개체로 끌어오면 기본 저장소에 추가됩니다. 정밀도를 위해 필드를 유정으로 직접 끌어올 수 있습니다. 다음 작업에서 이와 같이 필드를 끌어올 것입니다.*
...
4. **지역** 슬라이서에서 **Ctrl** 키를 누른 상태에서 여러 지역을 선택합니다.

5. 세로 막대형/꺾은선형 차트에서 월 열을 모두 선택하여 페이지를 교차 필터링합니다.

6. **Ctrl** 키를 누른 상태에서 월을 추가로 선택합니다.

	*기본적으로 교차 필터링은 페이지의 다른 모든 시각적 개체를 필터링합니다.*

7. 가로 막대 차트가 필터링되고 강조 표시되며 막대의 굵은 부분이 필터링된 월을 나타냅니다.

8. 막대형 차트 시각적 개체 위를 커서로 가리킨 다음 오른쪽 상단에 있는 필터 아이콘을 커서로 가리킵니다.
...
9. 커서를 막대 위로 가져간 다음, 도구 설명 정보를 확인합니다.

10. 교차 필터 실행을 취소하려면 세로 막대형/꺾은선형 차트에서 시각적 개체의 빈 영역을 클릭합니다.

11. 맵 시각적 개체 위를 마우스로 가리킨 다음 오른쪽 상단에 있는 **포커스** 아이콘을 클릭합니다.

	![그림 96](Linked_image_Files/07-design-report-in-power-bi-desktop_image65.png)

	*포커스 모드에서는 시각적 개체를 전체 페이지 크기로 확대합니다.*

12. 도구 설명을 표시하려면 원형 차트의 서로 다른 세그먼트 위로 커서를 가져갑니다.

13. 보고서 페이지로 돌아가려면 왼쪽 상단에 있는 **보고서로 돌아가기**를 클릭합니다.

	![그림 86](Linked_image_Files/07-design-report-in-power-bi-desktop_image66.png)

14. 맵 시각적 개체 위를 다시 커서로 가리킨 후 오른쪽 위에 있는 줄임표(...)를 클릭하고 메뉴 옵션을 살펴봅니다.

	![그림 97](Linked_image_Files/07-design-report-in-power-bi-desktop_image67.png)

15. **Team에서 채팅**을 제외한 각 옵션을 적용해 봅니다.

16. 왼쪽의 **페이지** 창에서 **이익** 페이지를 선택합니다.

	![그림 84](Linked_image_Files/07-design-report-in-power-bi-desktop_image68.png)

17. **지역** 슬라이서는 **개요** 페이지의 **지역** 슬라이서와는 다음 선택 옵션을 포함합니다.

	*슬라이서가 동기화되지 않습니다. **Power BI Desktop에서 보고서 디자인, 2부** 랩에서 보고서 디자인을 수정하여 슬라이서가 페이지 간에 동기화되는지 확인할 것입니다.*

18. **필터** 창(오른쪽에 위치)에서 필터 카드를 확장하고 일부 필터를 적용합니다.

	***필터** 창을 사용하면 슬라이서로서 한 페이지에 들어갈 수 있는 것보다 더 많은 필터를 정의할 수 있습니다.*

19. 행렬 시각적 개체에서 더하기(+) 단추를 사용하여 **회계** 계층 구조로 드릴합니다.

20. **내 실적** 페이지를 선택합니다.

	![그림 89](Linked_image_Files/07-design-report-in-power-bi-desktop_image69.png)

21. 메뉴 모음의 오른쪽 상단에서 **뷰**를 클릭한 다음 **전체 화면**을 선택합니다.

	![그림 98](Linked_image_Files/07-design-report-in-power-bi-desktop_image70.png)

22. 슬라이서를 수정하고 페이지를 교차 필터링하여 페이지와 상호 작용합니다.

23. 창 아래쪽에서 페이지를 변경하거나, 페이지 간을 정방향이나 역방향으로 이동하거나, 전체 화면 모드를 종료하는 명령을 확인합니다.

24. 왼쪽 아이콘을 클릭하여 전체 화면 모드를 종료합니다.
